...
func (vu *VideoUploadManagerService) ProcessUpload(concurrency int, doneUpload chan string) error {
...
func (vu *VideoUploadManagerService) uploadWorker(
	in chan int,
...
func (vu *VideoUploadManagerService) loadPaths() error {
